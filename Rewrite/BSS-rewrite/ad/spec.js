...
function get_info(data)
{
	layui.use('laydate', function() {
		...
		for(var i=0;i<val.length;i++)
		{
			...
			htm +='<td>'+laydate(val[i].createTime,"YYYY-MM-DD hh:mm:ss")+'</td><td>'+laydate(val[i].optime,"YYYY-MM-DD hh:mm:ss")+'</td><td><a class="specification-Edit" href="javascript:void(0)" onclick="show_edit('+val[i].asId+')" >编辑</a>&nbsp;</td>'
			htm +='</tr>';
		}
