 ...
 *
 */
public class AddSpreadGroup implements ApiHandler {
	...
	public void handle(HttpServletRequest request,
		...
		if (StringUtil.isEmpty(sgName) || spId < 1){
			throw new RuntimeException("参数异常!");
		}

		RespWrapper<Integer> result = service.addSpreadGroup(adUin, sgName, spId, operator);
		//===============日志记录
		String opContent = "新建推广组["+sgName+"]";
