 ...
 *
 */
public class GetAllSpreadGroup implements ApiHandler {
	...
	public void handle(HttpServletRequest request,
		...
		RespWrapper<DataPage<SpreadGroup>> result = service.findSpreadGroupPage(findParams, adUin, 1, Integer.MAX_VALUE);
