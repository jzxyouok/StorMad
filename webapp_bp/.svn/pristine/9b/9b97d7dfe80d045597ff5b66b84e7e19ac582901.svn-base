package com.yonghui.webapp.bp.api.ad.adlocation;
 ...
 * 
 * <br>
 * <b>功能：</b>获取单个广告位置信息<br>
 * <b>日期：</b>2016年11月9日<br>
 * <b>作者：</b>RUSH<br>
 *
 */
public class GetOneAdLocation implements ApiHandler {
	...
	public void handle(HttpServletRequest request,
		...
		RespWrapper<AdLocation> result = service.getOneAdLocation(alId);
