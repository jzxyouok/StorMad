...
<div class="gtarea">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="layoutTable">
      <tbody>
        ...
        <tr>
          <th width="6%">请输入密码：</th>
          <form action="/channel_user/edit_password" method="post" id="edit_password_submit">
          <td width="26%"><span class="input-sm">
            <input type="password" name="user_password" placeholder="输入密码" id="user_password" onblur="check(this)">
