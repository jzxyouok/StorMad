...
<div class="loginBox">
  ...
  <ul>
    <li><div class="loginline"><i class="iF">&#xe61f;</i> <input name="user_name" id="username" type="text" value="<?php echo ($this->input->cookie('user_name'))?$this->input->cookie('user_name'):''; ?>" placeholder="请输入用户名"></div></li>
    ...
    <li><div class="loginline" style="width:200px; display:inline-block;"><i class="iF">&#xe620;</i> <input style="width:136px" name="code" id="code" type="text" placeholder="请输入验证码"></div>&nbsp;<div style="float:right;padding-top:20px;"><img id="captcha_img" src="/login/get_code"></div></li>
  ...
  <p style=" line-height:24px; padding-top:8px;">注意事项：<b style="color:#ff6817;">请正确输入用户名、密码和验证码</b></p>
