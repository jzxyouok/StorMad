...
<div class="gtCon">
  ...
  <div class="gtarea" style="padding-left:35px;">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td>
        <button class="btn-cyan btn-sm" onclick="cut_report('campaign')" <?php if($report_type!='campaign'){?>style="background-color: #ccc;border: 0px;"<?php }?>> <b>推广计划</b></button>
        &ensp; <button class="btn-cyan btn-sm" onclick="cut_report('adgroup')" <?php if($report_type!='adgroup'){?>style="background-color: #ccc;border: 0px;"<?php }?>> <b>推广组</b></button>
        &ensp; <button class="btn-cyan btn-sm"  onclick="cut_report('adinfo')" <?php if($report_type!='adinfo'){?>style="background-color: #ccc;border: 0px;"<?php }?>> <b>广告</b></button>
        </td>
        <td align="right">
...
$(document).ready(function() {
	...
	//切换报表
	function cut_report(report_type) {
		...
		var order_field = 'id';
		var sort = 'desc';
		location.href = '/report/report_list/0/'+report_type+'/'+time+'/'+start_time+'/'+end_time+'/'+order_field+'/'+sort+'/<?php echo isset($cur_page)?$cur_page:1; ?>';
	}
	...
	function report_sort(report_type, order_field, sort) {
		...
		var start_time = '<?php echo isset($start_time)?$start_time:0;?>';
		var end_time = '<?php echo isset($end_time)?$end_time:0;?>';
		location.href = '/report/report_list/'+report_fid+'/'+report_type+'/'+time+'/'+start_time+'/'+end_time+'/'+order_field+'/'+sort+'/<?php echo isset($cur_page)?$cur_page:1; ?>';
	}
	...
	function find_adgroup(report_fid) {
		...
		var order_field = 'id';
		var sort = 'desc';
		location.href = '/report/report_list/'+report_fid+'/adgroup/'+time+'/'+start_time+'/'+end_time+'/'+order_field+'/'+sort+'/<?php echo isset($cur_page)?$cur_page:1; ?>';
	}
	...
	function find_adinfo(report_fid) {
		...
		var order_field = 'id';
		var sort = 'desc';
		location.href = '/report/report_list/'+report_fid+'/adinfo/'+time+'/'+start_time+'/'+end_time+'/'+order_field+'/'+sort+'/<?php echo isset($cur_page)?$cur_page:1; ?>';
	}
	...
	function download() {
		...
		location.href = '/report/download/'+report_fid+'/'+report_type+'/'+time+'/'+start_time+'/'+end_time;
	}
</script> 
