...
<div class="gtCon">
<!--  <div class="tips">
    我的账户情况，今日收益：<strong class="red"><?php echo $spend_money; ?></strong> 元
  </div> -->
  <div class="srcArea">
...
$(document).ready(function() {
	...
	function report_sort(order_field, sort) {
		...
		location.href = '/home/index/'+'/'+time+'/'+start_time+'/'+end_time+'/'+order_field+'/'+sort+'/<?php echo isset($cur_page)?$cur_page:1; ?>';
	}
