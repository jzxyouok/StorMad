...
class Report extends MY_Controller {
	...
	public function report_list($time=0, $start_time=0, $end_time=0, $order_field='id', $order_type='desc', $cur_page=1)
	{
		...
		$config['base_url'] = base_url()."/report/report_list/{$time}/{$start_time}/{$end_time}/{$order_field}/{$order_type}/";
		...
		$data['url'] = base_url()."/report/report_list/{$time}/{$start_time}/{$end_time}/{$order_field}/{$order_type}/";
