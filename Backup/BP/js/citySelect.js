$(document).ready(function() {
    ...
    function loadProvince() {
        ...
        form.on('select(province)', function(data) {
            ...
            $form.find('select[name=district]').html('<option value="">请选择县/区</option>').parent();
            ...
            if (count > 0) {
                ...
                $form.find('select[name=city]').parent();
            }
        });
    }
    //加载市数据
    function loadCity(citys) {
        ...
        form.on('select(city)', function(data) {
            ...
            if (count > 0) {
                ...
                $form.find('select[name=district]').parent();
            }
        });
    }
    //加载县/区数据
    function loadArea(areas) {
        ...
        //$form.find('select[name=district]').html(areaHtml).parent().show();
        $form.find('select[name=district]').html(areaHtml).parent();
        form.render();
