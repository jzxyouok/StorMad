...
public class ImageVerifyCode {
	...
	private static final String verify_code_key = "bss_login_verify_code";
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response, String id) throws Exception{
        ...
        String code = client.hget(verify_code_key, id);
    ...
    public static String createCode() {
        ...
        String id = newId();
        client.hset(verify_code_key, id, sRand);
        return id;
    }
	...
	public static boolean verifyCode(String id, String code) {
		String vcode = client.hget(verify_code_key, id);
		if (StringUtil.isNotEmpty(vcode) && vcode.equalsIgnoreCase(code)) {
			client.hdel(verify_code_key, id);
			return true;
		}
		return false;
	}
